...
const sendEmail = (email, username, password) => {
    let mailOptions = {
        ...
        html: `<p>Dear ${username},</p><p>Welcome to Optimatology Clinic! We are pleased to provide you with access to your online patient portal.</p><p>Your login credentials are as follows:</p><ul><li>Username: ${username}</li><li>Password: ${password}</li></ul><p>With your online account, you can:</p><ul><li>View your appointment history and upcoming appointments</li><li>Access your medical records</li></ul>`
    };
